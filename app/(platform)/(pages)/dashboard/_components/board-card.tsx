...
const BoardCard = ({
    ...
    const fetchTeam = async () => {
        try {
            const response = await axios.get(
                `http://localhost:8000/api/project/${id}/team/`,
                {
                    headers: {
    ...
    return (
        ...
        >
            ...
            <div
                className="flex h-full items-center align-middle justify-center"
                onClick={handleCardClick}
            >
                <Link key={id} href={`/project/${id}/board`}>
            ...
            <div className="w-full ">
                <div className="flex justify-between w-full">
                    <div className="w-full  ">Прогресс</div>
