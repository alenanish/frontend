...
export const Column = ( {id, index, name, value, boardId, Tasks} : ColumnProps ) => { 
    ...
    return (
            ...
            { name }
            <TaskAction boardId={boardId}  task_id={null} task_title={''} task_priority={''} task_description={''} task_created_at={getDate()} task_deadline={null} task_on_board={boardId} task_assignee={null} task_status={boardId===0? 'to-do' : boardId === 1 ? 'in-progress' : 'completed'}
                trigger={
